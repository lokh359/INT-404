...
@author: Lokhande Mahender,Basheer,Spandana,Pavankalyan Reddy
"""
...
radio=tk.Radiobutton(window, text="MAIL",width=20,value=1,fg="red",command=lambda: clicked())
radio.place(x=400,y=750)

radio=tk.Radiobutton(window, text="SMS",width=20,value=2,fg="red",command=lambda: clicked1())
radio.place(x=600,y=750)
...
copyWrite.insert("insert", "Developed by K18NS","", "TEAM", "superscript")
